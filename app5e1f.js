...
const PRODUCTS = [
  // SMARTPHONES
  { id:1,  name:"iPhone 15 Pro Max 256GB",            cat:"phones",      price:28, old:35, rating:4.9, rev:5432, img:"https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=600&q=80", discount:20, isNew:true,  hot:false, desc:"Titanium body, 48MP ProRAW camera system, A17 Pro chip, Dynamic Island, USB-C 3.0, and 5G." },
  { id:2,  name:"Samsung Galaxy S24 Ultra 512GB",     cat:"phones",      price:26, old:32, rating:4.8, rev:3120, img:"https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&q=80", discount:19, isNew:false, hot:true,  desc:"Dynamic AMOLED 2X display, 200MP camera, integrated S-Pen, 12GB RAM, Snapdragon 8 Gen 3." },
  { id:3,  name:"Google Pixel 8 Pro 256GB",           cat:"phones",      price:22, old:28, rating:4.8, rev:2341, img:"https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=600&q=80", discount:21, isNew:true,  hot:false, desc:"Google Tensor G3 chip, 50MP triple camera, 7 years OS updates, built-in Google AI features." },
  { id:4,  name:"OnePlus 12 256GB",                   cat:"phones",      price:20, old:25, rating:4.7, rev:1456, img:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&q=80", discount:20, isNew:false, hot:true,  desc:"Snapdragon 8 Gen 3, Hasselblad 50MP camera, 100W SUPERVOOC charging, 5400mAh battery." },
  { id:5,  name:"Samsung Galaxy A55 5G 256GB",        cat:"phones",      price:15, old:19, rating:4.6, rev:2876, img:"https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=600&q=80", discount:21, isNew:true,  hot:false, desc:"50MP OIS camera, 6.6\" Super AMOLED 120Hz, 5000mAh battery, IP67 water resistance." },
  { id:6,  name:"Xiaomi 14 Pro 512GB",                cat:"phones",      price:18, old:23, rating:4.7, rev:987,  img:"https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&q=80", discount:22, isNew:false, hot:false, desc:"Leica quad 50MP camera, Snapdragon 8 Gen 3, 120W HyperCharge, 6.73\" LTPO AMOLED 120Hz." },

  // LAPTOPS
  { id:7,  name:"MacBook Pro 14\" M3 Pro",            cat:"laptops",     price:30, old:38, rating:4.9, rev:2341, img:"https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&q=80", discount:21, isNew:false, hot:true,  desc:"M3 Pro chip, Liquid Retina XDR display, up to 18 hours battery, 18GB unified memory, 512GB SSD." },
  { id:8,  name:"ASUS ROG Zephyrus G16 RTX 4080",    cat:"laptops",     price:29, old:36, rating:4.7, rev:543,  img:"https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=600&q=80", discount:19, isNew:false, hot:true,  desc:"RTX 4080, Intel Core i9 HX, 240Hz OLED display, 32GB DDR5 RAM, 2TB NVMe SSD." },
  { id:9,  name:"Dell XPS 15 9530 OLED",              cat:"laptops",     price:25, old:31, rating:4.8, rev:1234, img:"https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=600&q=80", discount:19, isNew:false, hot:false, desc:"Intel Core i7 13700H, RTX 4060, 15.6\" 3.5K OLED, 32GB DDR5, 1TB SSD, InfinityEdge display." },
  { id:10, name:"Lenovo ThinkPad X1 Carbon Gen 11",   cat:"laptops",     price:23, old:29, rating:4.7, rev:876,  img:"https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600&q=80", discount:21, isNew:false, hot:false, desc:"Intel Core i7 vPro, 14\" IPS 2.8K, 32GB LPDDR5, 1TB SSD, MIL-SPEC tested, 15-hour battery." },
  { id:11, name:"HP Spectre x360 14\" 2-in-1",        cat:"laptops",     price:21, old:27, rating:4.7, rev:654,  img:"https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=600&q=80", discount:22, isNew:true,  hot:false, desc:"Intel Core Ultra 7, OLED 2.8K touch display, 360° convertible, Intel Arc GPU, 17-hour battery." },
  { id:12, name:"Microsoft Surface Laptop 5 15\"",    cat:"laptops",     price:19, old:24, rating:4.6, rev:432,  img:"https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600&q=80", discount:21, isNew:false, hot:false, desc:"Intel Core i7 12th Gen, 15\" PixelSense IPS, 16GB RAM, 512GB SSD, Dolby Vision & Atmos." },

  // CAMERAS
  { id:13, name:"Sony Alpha A7 IV Full-Frame",         cat:"cameras",     price:27, old:34, rating:4.9, rev:654,  img:"https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600&q=80", discount:21, isNew:false, hot:false, desc:"33MP full-frame BSI sensor, 4K 60fps video, real-time Eye AF, dual CFexpress + SD card slots." },
  { id:14, name:"Canon EOS R6 Mark II",                cat:"cameras",     price:25, old:32, rating:4.8, rev:876,  img:"https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600&q=80", discount:22, isNew:true,  hot:false, desc:"24.2MP CMOS, 4K 60fps 10-bit, up to 40fps burst, in-body 8-stop stabilization, 6072-point PDAF." },
  { id:15, name:"Fujifilm X-T5 40MP APS-C",           cat:"cameras",     price:22, old:28, rating:4.8, rev:432,  img:"https://images.unsplash.com/photo-1606986628255-30c80fc5b0b1?w=600&q=80", discount:21, isNew:false, hot:false, desc:"40MP X-Trans CMOS 5 HR, 7-stop IBIS, 8K video recording, compact retro body, 120fps at 4K." },
  { id:16, name:"GoPro Hero 12 Black",                 cat:"cameras",     price:16, old:20, rating:4.7, rev:3210, img:"https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=600&q=80", discount:20, isNew:false, hot:true,  desc:"5.3K60 video, HyperSmooth 6.0 stabilization, Max SuperView, waterproof to 33ft, extended battery." },
  { id:17, name:"DJI Air 3 Drone Combo",               cat:"cameras",     price:24, old:30, rating:4.8, rev:432,  img:"https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600&q=80", discount:20, isNew:true,  hot:false, desc:"Dual main cameras, 4K/60fps, 46-min max flight time, omnidirectional obstacle sensing, APAS 5.0." },
  { id:18, name:"Nikon Z6 III Full-Frame Mirrorless",  cat:"cameras",     price:26, old:33, rating:4.8, rev:321,  img:"https://images.unsplash.com/photo-1593697820642-ed1d04b65327?w=600&q=80", discount:21, isNew:true,  hot:false, desc:"24.5MP partially stacked CMOS, 6K RAW video, 20fps blackout-free shooting, Z-mount system." },

  // TELEVISIONS
  { id:19, name:"LG OLED C3 65\" 4K Smart TV",        cat:"tvs",         price:25, old:31, rating:4.8, rev:987,  img:"https://images.unsplash.com/photo-1593359677879-a4bb92f829e1?w=600&q=80", discount:19, isNew:false, hot:false, desc:"OLED self-lit pixels, 120Hz, Dolby Vision IQ, Dolby Atmos, Google TV, 4× HDMI 2.1, 65 inches." },
  { id:20, name:"Samsung 75\" Neo QLED 4K QN90C",     cat:"tvs",         price:28, old:35, rating:4.7, rev:543,  img:"https://images.unsplash.com/photo-1567690187548-f07b1d7bf5a9?w=600&q=80", discount:20, isNew:false, hot:false, desc:"Neo QLED MiniLED, Neural Quantum Processor 4K, 120Hz, Dolby Atmos, Samsung Gaming Hub." },
  { id:21, name:"Sony 55\" BRAVIA XR X90L 4K",        cat:"tvs",         price:20, old:25, rating:4.8, rev:765,  img:"https://images.unsplash.com/photo-1601944177325-f8867652837f?w=600&q=80", discount:20, isNew:false, hot:true,  desc:"Cognitive Processor XR, Full Array LED, Dolby Vision, HDMI 2.1, Google TV, Bravia Acoustic Multi-Audio." },
  { id:22, name:"LG 65\" QNED MiniLED 4K QNED90",    cat:"tvs",         price:18, old:23, rating:4.7, rev:432,  img:"https://images.unsplash.com/photo-1558888401-3cc1de77652d?w=600&q=80", discount:22, isNew:false, hot:false, desc:"QNED MiniLED panel, α7 AI 4K Gen6 processor, 120Hz, VRR, ALLM, Google Assistant, webOS 23." },
  { id:23, name:"Samsung 55\" QLED 4K Q80C",          cat:"tvs",         price:16, old:20, rating:4.6, rev:876,  img:"https://images.unsplash.com/photo-1461151304267-38535e780c79?w=600&q=80", discount:20, isNew:true,  hot:false, desc:"QLED panel, Quantum Processor 4K, 120Hz, HDR+, Object Tracking Sound, Smart TV with Bixby." },
  { id:24, name:"TCL 65\" QM8 MiniLED 4K TV",         cat:"tvs",         price:15, old:19, rating:4.6, rev:1234, img:"https://images.unsplash.com/photo-1571415060716-baff5f717c37?w=600&q=80", discount:21, isNew:false, hot:true,  desc:"MiniLED, 4K QLED 144Hz, Dolby Vision, HDR10+, HDMI 2.1, AMD FreeSync Premium, Google TV." },

  // TABLETS
  { id:25, name:"iPad Pro 12.9\" M2 Wi-Fi 256GB",     cat:"tablets",     price:24, old:30, rating:4.8, rev:1432, img:"https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600&q=80", discount:20, isNew:false, hot:true,  desc:"M2 chip, 12.9\" Liquid Retina XDR ProMotion 120Hz, USB-C Thunderbolt 4, Center Stage camera." },
  { id:26, name:"Samsung Galaxy Tab S9 Ultra",         cat:"tablets",     price:22, old:28, rating:4.8, rev:876,  img:"https://images.unsplash.com/photo-1589739900266-43b2843f4c12?w=600&q=80", discount:21, isNew:false, hot:true,  desc:"14.6\" Dynamic AMOLED 2X 120Hz, S Pen included, Snapdragon 8 Gen 2, 12GB RAM, IP68 rated." },
  { id:27, name:"iPad Air 5th Gen M1 256GB",           cat:"tablets",     price:18, old:23, rating:4.7, rev:1876, img:"https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=600&q=80", discount:22, isNew:false, hot:false, desc:"Apple M1 chip, 10.9\" Liquid Retina True Tone display, USB-C, 5G option, 12MP ultra-wide front camera." },
  { id:28, name:"Microsoft Surface Pro 9 i7",          cat:"tablets",     price:21, old:27, rating:4.7, rev:432,  img:"https://images.unsplash.com/photo-1617791160505-6f00504e3519?w=600&q=80", discount:22, isNew:true,  hot:false, desc:"Intel Core i7, 13\" PixelSense Flow 120Hz touch, 16GB RAM, 256GB SSD, Windows 11 Pro." },

  // ACCESSORIES
  { id:29, name:"Sony WH-1000XM5 Wireless ANC",       cat:"accessories", price:17, old:22, rating:4.9, rev:1876, img:"https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&q=80", discount:23, isNew:false, hot:false, desc:"Best-in-class ANC, 30-hour battery, 8 mics for clear calls, Hi-Res Audio Wireless, multipoint." },
  { id:30, name:"Apple Watch Ultra 2 Titanium",        cat:"accessories", price:25, old:31, rating:4.8, rev:876,  img:"https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=600&q=80", discount:19, isNew:true,  hot:false, desc:"Titanium case, brightest Apple Watch display, dual-frequency GPS, up to 60-hour battery, Action button." },
  { id:31, name:"AirPods Pro 2nd Generation",          cat:"accessories", price:15, old:19, rating:4.8, rev:5432, img:"https://images.unsplash.com/photo-1603351154351-5e2d0600bb77?w=600&q=80", discount:21, isNew:false, hot:true,  desc:"H2 chip, Adaptive Transparency, Personalized Spatial Audio, 6-hour ANC playback, MagSafe case." },
  { id:32, name:"Apple AirPods Max Silver",            cat:"accessories", price:20, old:25, rating:4.8, rev:2341, img:"https://images.unsplash.com/photo-1625842268584-8f3296236761?w=600&q=80", discount:20, isNew:false, hot:false, desc:"40mm Apple-designed driver, Adaptive EQ, Active Noise Cancellation, Transparency mode, USB-C." },
  { id:33, name:"Samsung Galaxy Buds 2 Pro",           cat:"accessories", price:15, old:19, rating:4.7, rev:3210, img:"https://images.unsplash.com/photo-1608156639585-b3a032ef9689?w=600&q=80", discount:21, isNew:true,  hot:false, desc:"24-bit Hi-Fi audio, ANC with 360 Audio, IPX7 water resistance, 8 hours per charge per earbud." },
  { id:34, name:"Bose QuietComfort 45 Headphones",     cat:"accessories", price:16, old:21, rating:4.7, rev:1432, img:"https://images.unsplash.com/photo-1546435770-a3e736813d7e?w=600&q=80", discount:24, isNew:false, hot:false, desc:"World-class ANC, 24-hour battery, Aware Mode, USB-C, multipoint Bluetooth, memory foam cushions." },
];
